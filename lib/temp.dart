...
import 'comms/localdb.dart';

final double cardHeight = 170;
final double txtSize = 18;

Container perCard(int index, BuildContext context) {
  final imgUrl = foodUrl + food[index]['img'];
  var priceOld = food[index]['priceOld'];
  var priceNew = food[index]['priceNew'];
  return Container(
      decoration:
...
//            ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                Text(food[index]['name'],style: TextStyle(fontSize: txtSize),),
                Image.asset(
